...
import styles from "./MobileShiftDetailPanel.module.css";

interface MobileShiftDetailPanelProps {
...
export default function MobileShiftDetailPanel({
  selectedDate,
  shifts,
  users,
  isAdmin,
